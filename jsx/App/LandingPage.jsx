...
[ENGLISH]:
 ...
 <p>Wi nawajo' nanab'ej chik chi rij ri taq tzijonem re', tab'ana' utzil katz'ib'an chire ri a Ryan Bennett (rbennett@ucsc.edu) o ri a Robert Henderson (rhenderson@arizona.edu).</p>
 <br/>
 ...
 <p>For additional information, please contact Ryan Bennett (rbennett@ucsc.edu) or Robert Henderson (rhenderson@arizona.edu).</p>
 </div>,
 [ESPANOL]:
 <div>
 ...
 <p>Un recordatorio para aquellas personas quienes participaron en este proyecto compartiendo su idioma y sus historias: si desea que hagamos algún cambio en su grabación o transcripción, incluso que borremos esos materiales de este sitio, comuníquese con Ryan Bennett (rbennett@ucsc.edu) o Robert Henderson (rhenderson@arizona.edu).</p>
 </div>,
 [FRANCAIS]:
 <div>
 Ütz ipetik! Ri xaq re' nuk'üt jun molaj tzijonem pa <a href="https://es.wikipedia.org/wiki/Idioma_cachiquel">Kaqchikel</a> ch'ab'äl, mayab' ch'ab'äl nich'ab'aläx pan Iximulew.
